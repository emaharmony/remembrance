...
Capture is FIRE-AND-FORGET: the hook builds the payload, spawns a detached
worker to do the (potentially slow) HTTP POST, and returns immediately so it
never makes you wait at the end of a turn.
